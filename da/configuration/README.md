# Da Configuration Guide

This directory contains the configuration management system for Da, handling all aspects of agent behavior, LLM
...
Da uses a hierarchical YAML configuration file (`agent.yml`) with the following main sections:
