...
from da.cli.tutorial import BenchmarkTutorial
from da.multi_round_benchmark import multi_benchmark, setup_base_parser_args
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Da: AI-powered SQL Agent for data engineering",
        parents=[global_parser],
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )

    # Add version argument
    parser.add_argument("-v", "--version", action="version", version=f"Da Agent {__version__}")
...
def main():
    ...
    if args.action == "platform-doc":
        ...
        from da.agent.agent import bootstrap_platform_doc
