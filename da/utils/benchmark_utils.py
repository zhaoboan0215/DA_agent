...
from da.tools.db_tools.db_manager import db_manager_instance, get_connection
...
class AgentResultSqlProvider(SqlProvider):
    """
    Parser for JSON files output by Da-Agent
    """
...
def _log_accuracy_summary(accuracy_report: Dict[str, Any], summary_report_file: Optional[str] = None) -> None:
    ...
    report_lines = [
        separator,
        f" Da Evaluation Summary (Total: {total_queries} Queries)",
        separator,
