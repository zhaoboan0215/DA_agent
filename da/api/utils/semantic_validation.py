...
When ``metricflow`` is installed (via ``DA-metricflow``), the full 5-layer
...
def validate_semantic_yaml(
    ...
    Args:
        ...
        DA_home: Da home directory path.
    ...
    if _check_metricflow():
        return _validate_deep(yaml_content, file_path, DA_home, datasource)
...
def _validate_deep(
    ...
    try:
        ...
        # ``DaPathManager.semantic_model_path()`` would make validation
        ...
        del DA_home  # resolution below is file_path-relative
