...
from da.api.models.kb_models import (
    BootstrapDocInput,
    BootstrapKbEvent,
    BootstrapKbInput,
    KbComponent,
...
from da.storage.metric.metric_init import init_success_story_metrics
...
from da.tools.db_tools.db_manager import DBManager
...
class KbService:
    ...
    def _run_doc_init(
        ...
        from da.storage.document.doc_init import init_platform_docs
    ...
    def _build_args(request: BootstrapKbInput, project_root: str) -> types.SimpleNamespace:
        """Create a SimpleNamespace mimicking argparse.Namespace for da init functions."""
    ...
    def _batch_event_to_sse(stream_id: str, component: str, event: BatchEvent) -> BootstrapKbEvent:
        """Convert a da BatchEvent into our SSE envelope."""
        progress = None
