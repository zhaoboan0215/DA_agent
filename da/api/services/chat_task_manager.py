...
from da.cli.autocomplete import AtReferenceCompleter
...
class ChatTaskManager:
    ...
    Owned by DaService — one instance per cached project.
    """
    ...
    def _create_node(
        ...
        if subagent_id:
            if subagent_id == "gen_semantic_model":
                from da.agent.node.gen_semantic_model_agentic_node import (
                ...
                from da.agent.node.gen_ext_knowledge_agentic_node import (
