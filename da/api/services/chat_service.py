...
class ChatService:
    ...
    Owned by DaService. Session management methods read from disk.
    """
    ...
    async def stream_chat(
        ...
        except (ValueError, DaException) as e:
            error_code = e.code.name if isinstance(e, DaException) else ErrorCode.COMMON_VALIDATION_FAILED.name
            yield SSEEvent(
                id=1,
                event="error",
