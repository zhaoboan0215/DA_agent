...
from da.storage.embedding_models import EmbeddingModel, get_document_embedding_model
...
class DocumentStore(BaseEmbeddingStore):
    ...
    def _validate_identifier(value: str, name: str) -> None:
        ...
        Raises:
            DaException: If the string contains unsafe characters
        """
...
def document_store(platform: str) -> DocumentStore:
    ...
    Raises:
        DaException: If *platform* is empty or contains invalid characters.
    """
