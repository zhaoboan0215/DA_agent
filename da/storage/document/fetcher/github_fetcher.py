...
from da.storage.document.fetcher.rate_limiter import RateLimiter, get_rate_limiter
from da.storage.document.schemas import SOURCE_TYPE_GITHUB, FetchedDocument
...
class GitHubFetcher(BaseFetcher):
    ...
    def _resolve_nav_map(
        ...
        """
        try:
            from da.storage.document.nav_resolver import NavResolverPipeline
