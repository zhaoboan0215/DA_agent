...
from da.utils.device_utils import get_device
...
class EmbeddingModel:
    ...
    def model(self):
        ...
        if self.is_model_failed:
            # If the stored error is already a formatted DaException message, use it directly
            if "error_code=" in self.model_error_message:
                # Extract just the core error message without the DaException wrapper
                import re
