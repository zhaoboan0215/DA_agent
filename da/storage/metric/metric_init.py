...
from da.storage.semantic_model.auto_create import ensure_semantic_models_exist, extract_tables_from_sql_list
...
def init_semantic_yaml_metrics(
    ...
    from da.storage.semantic_model.semantic_model_init import process_semantic_yaml_file
