...
from da.auth.oauth_config import CODEX_API_BASE_URL
...
class CodexModel(LLMBaseModel):
        ...
        **kwargs,
        ...
        async with multiple_mcp_servers(mcp_servers or {}) as connected_servers:
            ...
            try:
                ...
                raise DaException(ErrorCode.MODEL_MAX_TURNS_EXCEEDED, message_args={"max_turns": max_turns}) from e
            except Exception as e:
                from openai import AuthenticationError
    ...
    def _lookup_spec(self, field: str) -> Optional[int]:
        ...
        """
        from da.models.openai_compatible import _load_model_specs
