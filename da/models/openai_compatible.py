...
from da.models.litellm_adapter import LiteLLMAdapter
from da.models.mcp_result_extractors import extract_sql_contexts
...
from da.utils.text_utils import strip_litellm_placeholder
from da.utils.traceable_utils import setup_tracing
...
def _load_model_specs() -> Dict[str, Dict[str, int]]:
    ...
    ``~/.da/cache/openrouter_models.json`` provides a fallback ``context_length``
    ...
    with _MODEL_SPECS_LOCK:
        if _MODEL_SPECS_CACHE is None:
            ...
            try:
                from da.cli.provider_model_catalog import load_cached_model_details
