...
from da.configuration.agent_config import AgentConfig, ModelConfig
from da.schemas.action_history import ActionHistory, ActionHistoryManager
from da.utils.constants import LLMProvider
...
class LLMBaseModel(ABC):  # Changed from BaseModel to LLMBaseModel
    ...
    async def test_connection(self, timeout: float = 10.0) -> Tuple[bool, str]:
        ...
        Used by ``/model`` and the ``DA init`` wizard to verify provider
