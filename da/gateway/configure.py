...
"""Interactive configuration hub for Da Gateway IM channels.
...
from da.gateway.channel.registry import list_adapters, register_builtins
from da.gateway.models import ChannelConfig, Verbose
...
class ChannelConfigurator:
    ...
    def __init__(self, config_path: str = ""):
        ...
        try:
            ...
            if e.code == ErrorCode.COMMON_FILE_NOT_FOUND:
                ...
                console.print("Run 'da-agent init' first, or pass --config <path>.")
            else:
    ...
    def _render_hub(self) -> Tuple[str, Optional[str]]:
        ...
        rows: List[Tuple[str, str, bool]] = [
            ("__header__", f"Da Gateway channels — {self.cm.config_path}", False),
