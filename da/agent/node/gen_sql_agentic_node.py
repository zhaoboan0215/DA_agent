...
from da.tools.func_tool import ContextSearchTools, DBFuncTool, FilesystemFuncTool, PlatformDocSearchTool
...
from da.tools.mcp_tools import MCPServer
...
class GenSQLAgenticNode(AgenticNode):
    ...
    def _setup_plan_tools(self):
        ...
        """
        try:
            from da.tools.func_tool.plan_tools import PlanTool
    ...
    def _get_system_prompt(
        ...
        from da.utils.time_utils import get_default_current_date
    ...
    async def execute_stream(
        ...
        try:
            ...
            if is_plan_mode:
                ...
                from da.cli.plan_hooks import PlanModeHooks
            ...
            from da.utils.node_utils import resolve_database_name_for_prompt
