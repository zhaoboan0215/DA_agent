...
from da.schemas.chat_agentic_node_models import ChatNodeInput, ChatNodeResult
from da.schemas.date_parser_node_models import DateParserInput, DateParserResult
...
from da.schemas.fix_node_models import FixInput
from da.schemas.gen_sql_agentic_node_models import GenSQLNodeInput, GenSQLNodeResult
...
from da.schemas.reason_sql_node_models import ReasoningResult
from da.schemas.schema_linking_node_models import SchemaLinkingInput, SchemaLinkingResult
...
class Node(ABC):
    ...
    def new_instance(
        ...
        if node_type == NodeType.TYPE_SCHEMA_LINKING:
            ...
            from da.agent.node.explore_agentic_node import ExploreAgenticNode
            ...
            from da.agent.node.gen_job_agentic_node import GenJobAgenticNode
            ...
            from da.agent.node.gen_dashboard_agentic_node import GenDashboardAgenticNode
            ...
            from da.agent.node.scheduler_agentic_node import SchedulerAgenticNode
        ...
        if isinstance(input_data, dict):
            try:
                if node_dict["type"] == NodeType.TYPE_SCHEMA_LINKING:
                    ...
                    from da.schemas.gen_dashboard_agentic_node_models import GenDashboardNodeInput

                    input_data = GenDashboardNodeInput(**input_data)
                elif node_dict["type"] == NodeType.TYPE_SCHEDULER:
                    from da.schemas.scheduler_agentic_node_models import SchedulerNodeInput
        ...
        if isinstance(result_data, dict):
            try:
                ...
                if node_dict["type"] == NodeType.TYPE_SCHEMA_LINKING:
                    ...
                    from da.schemas.gen_report_agentic_node_models import GenReportNodeResult

                    result_data = GenReportNodeResult(**result_data)
                elif node_dict["type"] == NodeType.TYPE_EXPLORE:
                    result_data = ExploreNodeResult(**result_data)
                elif node_dict["type"] == NodeType.TYPE_GEN_DASHBOARD:
                    from da.schemas.gen_dashboard_agentic_node_models import GenDashboardNodeResult

                    result_data = GenDashboardNodeResult(**result_data)
                elif node_dict["type"] == NodeType.TYPE_SCHEDULER:
                    from da.schemas.scheduler_agentic_node_models import SchedulerNodeResult

                    result_data = SchedulerNodeResult(**result_data)
                elif node_dict["type"] == NodeType.TYPE_GEN_TABLE:
                    from da.schemas.semantic_agentic_node_models import SemanticNodeResult
