...
from da.agent.node.compare_agentic_node import CompareAgenticNode
from da.cli.execution_state import ExecutionInterrupted
...
from da.schemas.compare_node_models import CompareInput
from da.schemas.ext_knowledge_agentic_node_models import ExtKnowledgeNodeInput, ExtKnowledgeNodeResult
from da.schemas.node_models import SQLContext, SqlTask
from da.tools.func_tool import DBFuncTool
from da.tools.func_tool.base import FuncToolResult
from da.tools.func_tool.context_search import ContextSearchTools
from da.tools.func_tool.filesystem_tools import FilesystemFuncTool
from da.tools.func_tool.generation_tools import GenerationTools
from da.utils.benchmark_utils import ComparisonOutcome, TableComparator
from da.utils.loggings import get_logger
from da.utils.message_utils import MessagePart, build_structured_content
from da.utils.node_utils import build_database_context
...
class GenExtKnowledgeAgenticNode(AgenticNode):
    ...
    def _validate_gold_sql(self, gold_sql: str) -> None:
        ...
        Raises:
            DaException: with code NODE_EXT_KNOWLEDGE_GOLD_SQL_INVALID when
...
"""
    ...
    def _prepare_template_context(self, user_input: ExtKnowledgeNodeInput, gold_sql: Optional[str] = None) -> dict:
        ...
        """
        from da.utils.node_utils import build_datasource_prompt_context
...
- Do NOT include code block markers (```) in the returned strings"""
    ...
    def _get_system_prompt(
        ...
        try:
            ...
            from da.prompts.prompt_manager import get_prompt_manager
            ...
            # Template not found - throw DaException
            from da.utils.exceptions import DaException, ErrorCode
            ...
            # Other template errors - wrap in DaException
    ...
    async def execute_stream(
        ...
        try:
            ...
            # - Non-empty but unrunnable gold_sql: raise DaException here
    ...
    def _extract_ext_knowledge_and_output_from_response(self, output: dict) -> tuple[Optional[str], Optional[str]]:
        ...
        """
        try:
            from da.utils.json_utils import strip_json_str
