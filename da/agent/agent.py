...
from da.configuration.agent_config import AgentConfig, BenchmarkConfig
...
from da.storage.ext_knowledge.ext_knowledge_init import init_ext_knowledge, init_success_story_knowledge
from da.storage.ext_knowledge.store import ExtKnowledgeRAG
from da.storage.metric.metric_init import init_semantic_yaml_metrics, init_success_story_metrics
from da.storage.metric.store import MetricRAG
from da.storage.schema_metadata import SchemaWithValueRAG
from da.storage.schema_metadata.benchmark_init import init_snowflake_schema
from da.storage.schema_metadata.benchmark_init_bird import init_dev_schema
from da.storage.schema_metadata.local_init import init_local_schema
from da.storage.semantic_model.semantic_model_init import (
...
from da.tools.db_tools.db_manager import DBManager, db_manager_instance
from da.utils.benchmark_utils import load_benchmark_tasks
...
from da.utils.time_utils import format_duration_human
from da.utils.traceable_utils import optional_traceable
...
class Agent:
        ...
        for component in selected_components:
            ...
            if component == "metadata":
                ...
                if hasattr(self.args, "from_adapter") and self.args.from_adapter:
                    ...
                    from da.storage.semantic_model.adapter_init import init_from_adapter
                ...
                if hasattr(self.args, "from_adapter") and self.args.from_adapter:
                    # Pull from semantic adapter
                    from da.storage.metric.adapter_init import init_from_adapter
                ...
                from da.storage.reference_sql import ReferenceSqlRAG
                ...
                from da.storage.reference_template import ReferenceTemplateRAG
                from da.storage.reference_template.reference_template_init import init_reference_template
    ...
    def evaluation(self, log_summary: bool = True) -> Dict[str, Any]:
        ...
        from da.utils.benchmark_utils import evaluate_benchmark_and_report
...
def bootstrap_platform_doc(args: argparse.Namespace, agent_config: AgentConfig):
    ...
    from da.storage.document import infer_platform_from_source, init_platform_docs
