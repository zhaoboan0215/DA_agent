...
``stdin`` once via :meth:`DaApp.suspend_input`.  Visual style mirrors
:class:`DA.cli.model_app.ModelApp`: ``CLR_CURSOR`` highlight, ``→`` cursor,
...
SCOPE_CHOICES: Dict[str, str] = {
    "project": ".da/config.yml (this project only)",
