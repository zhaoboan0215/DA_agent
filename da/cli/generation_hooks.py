...
from da.cli.execution_state import InteractionBroker, InteractionCancelled
...
class GenerationHooks(AgentHooks):
    ...
    def _sync_reference_template_to_db(
        ...
        """
        try:
            from da.storage.reference_template.init_utils import (
            ...
            from da.storage.reference_template.template_file_processor import extract_template_parameters
