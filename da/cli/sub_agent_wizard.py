...
class SubAgentWizard:
    ...
    def __init__(self, cli_instance: "DaCLI", data: Optional[Union[SubAgentConfig, Dict[str, Any]]] = None):
    ...
    def native_tools_choices(self) -> Dict[str, List[str]]:
        from da.tools.func_tool import ContextSearchTools, DBFuncTool
...
def run_wizard(
    cli_instance: "DaCLI", data: Optional[Union[SubAgentConfig, Dict[str, Any]]] = None
