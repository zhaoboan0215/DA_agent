...
``DA.cli.service_client.READ_METHODS`` is rejected with a clear error
...
from da.cli._render_utils import build_kv_table, build_row_table
from da.cli.cli_styles import TABLE_HEADER_STYLE, print_error, print_info, print_warning
from da.cli.service_client import ServiceClient, ServiceClientRegistry, service_type_label
...
class ServiceCommands:
    ...
    # ------------------------------------------------------------------ #
    # Entry points wired into DaCLI.commands / _execute_internal_command
    # ------------------------------------------------------------------ #
    ...
    # corresponding ``DA-*-core`` framework is a transitive dependency
    ...
    _ADAPTER_PACKAGE_HINTS = {
        "bi_platforms": "DA-bi-<platform>  (e.g. DA-bi-superset, DA-bi-grafana)",
        "schedulers": "DA-scheduler-<platform>  (e.g. DA-scheduler-airflow)",
        "semantic_layer": "DA-semantic-<type>  (e.g. DA-semantic-metricflow)",
    }
    ...
    def _run_async(self, coro) -> Any:
        ...
        Scheduling this on the shared ``DaCLI._bg_loop`` would freeze
