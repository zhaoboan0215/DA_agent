...
"""
Enhanced MCP (Model Context Protocol) server management screen for Da CLI.
...
from da.tools.mcp_tools import MCPServerType, MCPTool
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="mcp-container"):
            with Container(id="mcp-main-panel"):
                ...
                # cache_path = os.path.expanduser("~/.da")
                yield Static(
