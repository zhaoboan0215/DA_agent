...
"""
Agent, workflow, and node-related commands for the Da CLI.
...
from da.agent.evaluate import setup_node_input, update_context_from_node
from da.agent.node import Node
from da.agent.workflow import Workflow
from da.cli.cli_styles import CODE_THEME, print_error, print_success, print_warning
from da.cli.subject_rich_utils import build_historical_sql_tags
...
from da.schemas.node_models import ExecuteSQLInput, GenerateSQLInput, OutputInput, SqlTask
...
from da.tools.output_tools import OutputTool
...
class AgentCommands:
    ...
    def __init__(self, cli_instance: "DaCLI", cli_context):
    ...
    def cmd_darun_screen(self, args: str, task: SqlTask = None):
        ...
        try:
            ...
            from da.cli.screen import show_workflow_screen
