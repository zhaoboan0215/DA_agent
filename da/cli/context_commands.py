...
"""
DA-CLI Context Commands
This module provides context-related commands for the Da CLI.
"""

from typing import TYPE_CHECKING

from da.cli.cli_styles import print_error
from da.cli.screen import show_subject_screen
...
class ContextCommands:
    ...
    def cmd_catalog(self, args: str):
        ...
        try:
            ...
            from da.cli.screen import show_catalog_screen
