...
"""
Chat-related commands for the Da CLI.
...
from da.cli.action_display.display import ActionHistoryDisplay
from da.cli.execution_state import ExecutionInterrupted, auto_submit_interaction
...
from da.utils.terminal_utils import EscapeGuard, interrupt_on_escape
...
class ChatCommands:
    ...
    def __init__(self, cli_instance: "DaCLI"):
    ...
    def _create_new_node(self, subagent_name: str = None):
        ...
        """
        from da.agent.node.node_factory import create_interactive_node
    ...
    def create_node_input(
        ...
        """
        from da.agent.node.node_factory import create_node_input as _create_node_input
    ...
    def _execute_chat(
        ...
        try:
            ...
            if interactive:
                ...
                # (see ``DaCLI._init_tui_app``), which consult this
    ...
    def _make_input_collector(self, esc_guard):
        ...
        def _collect_multi_choice(console, choices, allow_free_text):
            ...
            from da.cli._cli_utils import select_multi_choice
    ...
    def _extract_node_type_from_session_id(session_id: str) -> str:
        ...
        from da.models.session_manager import extract_agent_from_session_id
    ...
    def cmd_resume(self, args: str):
        ...
        from da.models.session_manager import SessionManager, session_matches_agent
