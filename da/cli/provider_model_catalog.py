...
an ever-expanding local list. Failures silently fall back through:
  ...
  L2 Cached file at ~/.da/cache/openrouter_models.json
  L3 Local catalog from da/conf/providers.yml
...
# onto the provider keys used in da/conf/providers.yml.
...
def _cache_file_path() -> Path:
    return get_path_manager().DA_home / "cache" / CACHE_FILE_NAME
