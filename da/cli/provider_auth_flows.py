...
"""Provider authentication helper flows shared by ``DA init`` and ``/model``.
...
that via :meth:`DA.models.base.LLMBaseModel.test_connection`.
"""
...
from da.cli._cli_utils import prompt_input, select_choice
