...
from da.cli.cli_styles import TABLE_HEADER_STYLE, print_error, print_success, print_usage, print_warning
from da.cli.sub_agent_wizard import run_wizard
...
class SubAgentCommands:
    def __init__(self, cli_instance: "DaCLI"):
        self.cli_instance: "DaCLI" = cli_instance
