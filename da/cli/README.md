...
Da-CLI is a data engineering agent that builds evolvable context for your data system. It combines the power of AI with a modern TUI experience to enhance SQL development efficiency.
...
6. Chat with AI:
````sql
Da> / Can you explain this query's performance?
...
Da> !bash ls output
02bd515a.csv
Da> !bash cat output/02bd515a.csv
...
...
Da-CLI supports several types of commands, each with its own prefix:
