...
from da.tools.func_tool.fs_path_policy import PathZone, classify_path
...
class FilesystemPolicy:
    ...
    :func:`DA.tools.func_tool.fs_path_policy.classify_path` on every
