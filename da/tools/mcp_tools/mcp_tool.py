...
from da.tools.base import BaseTool, BaseToolExecResult, ToolAction
from da.tools.mcp_tools.mcp_config import ToolFilterConfig
from da.tools.mcp_tools.mcp_manager import MCPManager, create_static_tool_filter
...
def parse_command_string(s: str) -> Tuple[str, Optional[str], Dict[str, Any]]:
    ...
    if not transport_seg:
        raise DaException(ErrorCode.COMMON_FIELD_INVALID, message="No --transport found.")
