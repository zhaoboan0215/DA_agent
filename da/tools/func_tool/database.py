...
from da.utils.compress_utils import DataCompressor
from da.utils.constants import DBType, SQLType
from da.utils.exceptions import DaException, ErrorCode
from da.utils.loggings import get_logger
from da.utils.mcp_decorators import mcp_tool, mcp_tool_class
...
class DBFuncTool:
    ...
    def _check_sql_table_scope(self, sql: str) -> List[str]:
        ...
        if not self._scoped_patterns:
            return []
        from da.utils.sql_utils import extract_table_names
    ...
    def read_query(self, sql: str, datasource: Optional[str] = "") -> FuncToolResult:
        ...
        """
        from da.utils.sql_utils import _first_statement, parse_sql_type
        ...
        try:
            ...
            from da.utils.sql_utils import strip_sql_comments
    ...
    def execute_write(
        ...
        """
        from da.utils.sql_utils import _first_statement, parse_sql_type, strip_sql_comments
    ...
    # connector. Uses duck typing so any DA-db-core >= the version that
