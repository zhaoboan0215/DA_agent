...
from da.schemas.base import TABLE_TYPE, BaseInput, BaseResult
from da.schemas.doc_search_node_models import DocSearchResult
...
class ExecuteSQLResult(BaseResult):
    ...
    def compact_result(self) -> str:
        ...
        Only includes row count and truncated sql return (max length defined by DA_MAX_RESULT_LENGTH).
        Returns:
