...
Requires:
- Airflow running on localhost:8080 (docker compose -f ../DA-scheduler-adapters/DA-scheduler-airflow/docker-compose.yml up -d)
- DA-scheduler-core package installed
...
def scheduler_agent_config():
    ...
    pytest.importorskip("DA_scheduler_core")
    pytest.importorskip("DA_scheduler_airflow")
