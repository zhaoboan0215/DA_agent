...
Requires:
- Superset running on localhost:8088 (docker compose -f ../DA-bi-adapters/DA-bi-superset/tests/integration/docker-compose.yml up -d)
- DA-bi-superset package installed
...
def dashboard_agent_config():
    ...
    pytest.importorskip("DA_bi_superset", reason="DA-bi-superset package not installed")
