...
REAL_SKILLS_DIR = Path.home() / ".DA" / "skills"
REAL_SQLITE_DB = Path.home() / ".DA" / "benchmark" / "california_schools" / "california_schools.sqlite"
...
@pytest.fixture
def mock_args():
    """Provides default mock arguments for initializing DaCLI."""
    return Namespace(
        history_file="~/.da/reference_sql",
        debug=False,
        datasource="bird_school",
