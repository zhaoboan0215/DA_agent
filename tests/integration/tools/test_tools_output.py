...
from da.schemas.node_models import ExecuteSQLInput, OutputInput
...
from da.tools.output_tools.output import OutputTool
...
class TestBirdDevOutput:
    ...
    def global_config(self, tmp_path, monkeypatch) -> AgentConfig:
        # chdir to tmp_path so the yml's ``home: .da_test_data`` relative
