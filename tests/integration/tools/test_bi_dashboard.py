...
from da.cli.bi_dashboard import BiDashboardCommands, DashboardCliOptions
from da.configuration.agent_config import AgentConfig
from da.configuration.agent_config_loader import load_agent_config
from da.tools.bi_tools.dashboard_assembler import ChartSelection, DashboardAssembler
...
def agent_config(tmp_path_factory) -> AgentConfig:
    ...
    real RAG storage (e.g. `.da_test_data/...`), and the E2E test's cleanup
    ...
    # developer's real `.da_test_data/workspace/` — E2E cleanup could then
    ...
    def test_workflow_without_llm(
        ...
        for dashboard_item in input_data:
            ...
            try:
                ...
                with (
                    patch("da.cli.bi_dashboard.init_reference_sql") as mock_ref_sql,
                    patch("da.cli.bi_dashboard.init_semantic_model") as mock_semantic,
                    patch("da.cli.bi_dashboard.init_metrics") as mock_metrics,
