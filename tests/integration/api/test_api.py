...
from da.api.legacy_models import FeedbackResponse, RunWorkflowResponse
...
async def api_client(app, agent_args):
    ...
    mock_service = DaAPIService(agent_args)
...
class TestAPI:
    ...
    async def test_sync_workflow(self, authenticated_client):
        ...
        with patch.object(DaAPIService, "run_workflow") as mock_run:
    ...
    async def test_stream_workflow(self, authenticated_client):
        ...
        with patch.object(DaAPIService, "run_workflow_stream") as mock_stream:
    ...
    async def test_feedback(self, authenticated_client):
        ...
        with patch.object(DaAPIService, "record_feedback") as mock_feedback:
