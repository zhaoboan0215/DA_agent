...
from da.schemas.node_models import GenerateSQLResult
from da.schemas.parallel_node_models import SelectionInput, SelectionResult
...
class TestSelectionNodeExecute:
    ...
    def test_execute_multiple_candidates_with_llm(self):
        ...
        with patch("da.agent.node.selection_node.create_selection_prompt", return_value="prompt"):
            node.execute()
