...
def mock_llm_model():
    ...
    with patch("da.models.base.LLMBaseModel.create_model", return_value=None):
        yield
...
"""
        ...
        from da.tools.skill_tools.skill_config import SkillConfig as _Cfg
...
class TestSkillIntegrationEdgeCases:
    ...
    def test_setup_exception_handling(self, mock_agent_config):
        ...
        with patch("da.tools.skill_tools.skill_func_tool.SkillFuncTool", side_effect=Exception("Test error")):
            node = MinimalAgenticNode(
                node_id="test25",
                description="Test node",
                node_type="chat",
...
class TestSkillAllowedAgentsConsistency:
    ...
    def _read_skill_frontmatter(name: str) -> dict:
        ...
        skill_path = project_root / "da" / "resources" / "skills" / name / "SKILL.md"
