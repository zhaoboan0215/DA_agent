...
from da.schemas.date_parser_node_models import DateParserInput, DateParserResult, ExtractedDate
...
class TestDateParserNodeExecute:
    ...
    def test_execute_success(self):
        ...
        with patch("da.utils.time_utils.get_default_current_date", return_value="2024-01-15"):
            with patch("da.agent.node.date_parser_node.DateParserTool") as mock_tool_cls:
                mock_tool = MagicMock()
    ...
    def test_execute_with_exception(self):
        ...
        with patch("da.agent.node.date_parser_node.DateParserTool", side_effect=RuntimeError("parse error")):
            node.execute()
