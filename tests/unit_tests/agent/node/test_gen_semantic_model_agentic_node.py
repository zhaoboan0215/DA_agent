...
class TestSaveToDb:
    def test_save_to_db_skips_nonexistent_file(self, real_agent_config, mock_llm_create, tmp_path):
        ...
        with patch(
            "da.agent.node.gen_semantic_model_agentic_node.GenerationHooks._sync_semantic_to_db"
        ) as sync_mock:
    ...
    def test_save_to_db_rejects_out_of_sandbox_absolute_path(self, real_agent_config, mock_llm_create, tmp_path):
        ...
        with patch("da.cli.generation_hooks.GenerationHooks._sync_semantic_to_db") as sync_mock:
