...
"""Unit tests for da/api/services/visualization_service.py — CI level, zero external deps."""

from unittest.mock import Mock, patch

import pytest

from da.api.models.visualization_models import CsvData
from da.api.services.visualization_service import DataVisualizationService

_LLM_PATH = "da.api.services.visualization_service.LLMBaseModel"
_VIZ_TOOL_PATH = "da.api.services.visualization_service.VisualizationTool"
_TOOL_PROMPT_PATH = "da.tools.llms_tools.visualization_tool.get_prompt_manager"
...
class TestGenerateWithContext:
    ...
    def _setup_context_svc(self, mock_agent_config, llm_response):
        ...
        from da.tools.llms_tools.visualization_tool import VisualizationTool
...
class TestCaching:
    ...
    def test_evicts_lru_when_over_capacity(self, mock_agent_config):
        import da.api.services.visualization_service as viz_mod
