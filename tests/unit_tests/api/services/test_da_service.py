"""Tests for DA.api.services.da_service — per-project service facade."""
...
class TestDaServiceInit:
    """Tests for DaService construction."""
    ...
    def test_init_stores_config_and_project_id(self, real_agent_config):
        ...
        svc = DaService(agent_config=real_agent_config, project_id="test-proj")
    ...
    def test_init_creates_task_manager(self, real_agent_config):
        ...
        svc = DaService(agent_config=real_agent_config, project_id="p1")
...
class TestDaServiceLazyProperties:
...
class TestDaServiceBehavior:
    ...
    def test_config_fingerprint_is_stable(self, real_agent_config):
        ...
        svc1 = DaService(agent_config=real_agent_config, project_id="p1")
        svc2 = DaService(agent_config=real_agent_config, project_id="p2")
