"""Tests for DA.api.services.chat_task_manager — background task management."""
...
from da.api.services.chat_task_manager import (
    ChatTask,
    ChatTaskManager,
    _coalesce_deltas,
...
class TestChatTaskManagerBehavior:
    ...
    async def test_push_event_appends_to_buffer(self):
        ...
        from da.api.models.cli_models import SSEEvent, SSEPingData
...
class TestStartChat:
    ...
    async def test_consume_events_yields_ping_when_idle(self, monkeypatch):
        ...
        from da.api.models.cli_models import SSEEvent, SSEPingData
        from da.api.services import chat_task_manager as ctm
...
class TestRunLoopPathManagerContext:
    ...
    async def test_run_loop_sets_path_manager_when_context_is_empty(self, real_agent_config, mock_llm_create):
        ...
        from da.api.models.cli_models import StreamChatInput
        from da.utils.path_manager import (
    ...
    async def test_run_loop_does_not_leak_path_manager_to_caller(self, real_agent_config, mock_llm_create):
        ...
        from da.api.models.cli_models import StreamChatInput
        from da.utils.path_manager import _current_path_manager, reset_path_manager
...
class TestCreateNodeCustomSubAgent:
    ...
    def test_custom_subagent_resolves_sanitized_key(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "da.api.services.chat_task_manager.GenSQLAgenticNode",
            _StubGenSQLNode,
        )
