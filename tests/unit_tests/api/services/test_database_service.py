"""Tests for DA.api.services.database_service — datasource management."""

import pytest

from da.api.models.database_models import ListDatabasesInput
...
class TestGetSemanticModel:
    ...
    async def test_validate_semantic_model_nonexistent(self, real_agent_config):
        ...
        from da.api.models.table_models import SemanticModelInput
