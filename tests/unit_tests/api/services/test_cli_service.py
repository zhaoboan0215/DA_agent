"""Tests for DA.api.services.cli_service — CLI command operations."""
...
from da.api.models.cli_models import ExecuteContextInput, ExecuteSQLInput
...
class TestCLIServiceExecuteSQL:
    ...
    async def test_execute_sql_select_success(self, cli_svc):
        ...
        from da.api.models.cli_models import ExecuteSQLData
...
class TestCLIServiceExecuteContext:
    ...
    def test_context_tables(self, cli_svc):
        ...
        from da.api.models.cli_models import ExecuteContextData, TableInfo
...
class TestCLIServiceExecuteInternalCommand:
    ...
    def test_help_command(self, cli_svc):
        ...
        from da.api.models.cli_models import InternalCommandInput
