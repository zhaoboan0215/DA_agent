"""Tests for DA.api.utils.semantic_validation."""

from unittest.mock import patch

import pytest

from da.api.utils import semantic_validation
...
class TestDeepValidation:
    ...
    @patch("da.api.utils.semantic_validation._check_metricflow", return_value=True)
