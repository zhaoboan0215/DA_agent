"""Tests for DA.api.service — FastAPI app creation and DaAPIService."""
...
class TestDaAPIServiceInit:
    """Tests for DaAPIService initialization."""

    def test_init_sets_defaults(self):
        """DaAPIService starts with empty agents, no config, no task store."""
        args = argparse.Namespace(config="", namespace="default")
        svc = DaAPIService(args)
        assert svc.agents == {}
...
class TestDaAPIServiceGenerateTaskId:
