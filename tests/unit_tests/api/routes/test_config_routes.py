...
"""Unit tests for da/api/routes/config_routes.py."""
...
from da.api.routes import config_routes
from da.api.routes.config_routes import (
...
def _mock_svc(datasources, *, target="deepseek", current_datasource="starrocks", models=None, home="~/.da"):
    svc = MagicMock()
