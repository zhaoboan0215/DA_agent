...
class TestOpenAIModel:
    def _make(self, model_name="gpt-4o", api_key="test-key"):
        from da.models.openai_model import OpenAIModel

        config = _make_model_config(model=model_name, api_key=api_key)
        with patch("da.models.openai_compatible.OpenAICompatibleModel.__init__", return_value=None):
    ...
    def test_generate_transforms_max_tokens_for_reasoning(self):
        ...
        with patch(
            "da.models.openai_compatible.OpenAICompatibleModel.generate", return_value="response"
        ) as mock_gen:
...
class TestQwenModel:
    def _make(self, api_key="test-qwen-key", base_url=None):
        from da.models.qwen_model import QwenModel
...
class TestKimiModel:
    def _make(self, api_key="test-kimi-key", base_url=None):
        from da.models.kimi_model import KimiModel
...
class TestGeminiModel:
    def _make(self, api_key="test-gemini-key", base_url=None):
        from da.models.gemini_model import GeminiModel
...
class TestOpenRouterModel:
    def _make(self, api_key="test-openrouter-key", base_url=None):
        from da.models.openrouter_model import OpenRouterModel
...
class TestMiniMaxModel:
    def _make(self, api_key="test-minimax-key", base_url=None):
        from da.models.minimax_model import MiniMaxModel
...
class TestGLMModel:
    def _make(self, api_key="test-glm-key", base_url=None):
        from da.models.glm_model import GLMModel
