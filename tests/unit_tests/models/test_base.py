...
"""Unit tests for ``DA.models.base.LLMBaseModel.test_connection``."""
...
class TestTestConnection:
    ...
    def test_returns_false_on_timeout(self):
        ...
        with patch("da.models.base.asyncio.wait_for", side_effect=asyncio.TimeoutError):
...
class TestCreateModelCache:
    ...
    def test_same_config_returns_cached_instance(self):
        ...
        with patch.dict("sys.modules", {"da.models.openai_model": module}):
