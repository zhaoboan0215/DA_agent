...
"""Tests for :class:`DA.cli.autocomplete.SlashCommandCompleter`.
...
from da.cli.autocomplete import SlashCommandCompleter
from da.cli.slash_registry import SLASH_COMMANDS, iter_visible
