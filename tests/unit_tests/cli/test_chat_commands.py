...
"""
Unit tests for da/cli/chat_commands.py.
...
ChatCommands needs without constructing a full DaCLI.
"""
...
from da.cli.chat_commands import ChatCommands, _is_model_config_error
...
class MinimalCLI:
    """Lightweight real CLI substitute for testing ChatCommands without full DaCLI.
    ...
    def run_on_bg_loop(self, coro):
        """Simple synchronous stand-in for ``DaCLI.run_on_bg_loop``.
...
class TestCreateNewNode:
    ...
    def test_default_chat_node_creation(self, real_agent_config, mock_llm_create):
        ...
        from da.agent.node.chat_agentic_node import ChatAgenticNode
    ...
    def test_gensql_node_creation(self, real_agent_config, mock_llm_create):
        ...
        from da.agent.node.chat_agentic_node import ChatAgenticNode
        from da.agent.node.gen_sql_agentic_node import GenSQLAgenticNode
    ...
    def test_gen_semantic_model_node_creation(self, real_agent_config, mock_llm_create):
        ...
        from da.agent.node.gen_semantic_model_agentic_node import GenSemanticModelAgenticNode
    ...
    def test_gen_metrics_node_creation(self, real_agent_config, mock_llm_create):
        ...
        from da.agent.node.gen_metrics_agentic_node import GenMetricsAgenticNode
    ...
    def test_gen_sql_summary_node_creation(self, real_agent_config, mock_llm_create):
        ...
        from da.agent.node.sql_summary_agentic_node import SqlSummaryAgenticNode
    ...
    def test_gen_report_node_creation(self, real_agent_config, mock_llm_create):
        ...
        from da.agent.node.gen_report_agentic_node import GenReportAgenticNode
...
class TestCreateNodeInput:
    ...
    def test_chat_node_gets_chat_input(self, real_agent_config, mock_llm_create):
        ...
        from da.agent.node.chat_agentic_node import ChatAgenticNode
        from da.schemas.chat_agentic_node_models import ChatNodeInput
    ...
    def test_gensql_node_input(self, real_agent_config, mock_llm_create):
        ...
        from da.agent.node.gen_sql_agentic_node import GenSQLAgenticNode
        from da.schemas.gen_sql_agentic_node_models import GenSQLNodeInput
    ...
    def test_semantic_model_node_input(self, real_agent_config, mock_llm_create):
        ...
        from da.agent.node.gen_semantic_model_agentic_node import GenSemanticModelAgenticNode
        from da.schemas.semantic_agentic_node_models import SemanticNodeInput
    ...
    def test_sql_summary_node_input(self, real_agent_config, mock_llm_create):
        ...
        from da.agent.node.sql_summary_agentic_node import SqlSummaryAgenticNode
        from da.schemas.sql_summary_agentic_node_models import SqlSummaryNodeInput
    ...
    def test_gen_report_node_input(self, real_agent_config, mock_llm_create):
        ...
        from da.agent.node.gen_report_agentic_node import GenReportAgenticNode
        from da.schemas.gen_report_agentic_node_models import GenReportNodeInput
...
class TestDisplaySuccess:
    ...
    def _render_and_get_output(self, action):
        ...
        """
        from da.cli.action_display.renderers import ActionContentGenerator, ActionRenderer
...
class TestSelectChoiceWithPipeInput:
    ...
    def test_select_choice_returns_sent_key(self, real_agent_config, mock_llm_create):
        ...
        from da.cli._cli_utils import select_choice
    ...
    def test_prompt_input_returns_text(self, real_agent_config, mock_llm_create):
        ...
        from da.cli._cli_utils import prompt_input
...
class TestCmdRewindWithSession:
    ...
    def test_rewind_turn2_returns_message_and_keeps_turn1(self, real_agent_config, mock_llm_create):
        ...
        from da.models.session_manager import SessionManager
    ...
    def test_rewind_cancel_returns_none(self, real_agent_config, mock_llm_create, monkeypatch):
        ...
        import da.cli.chat_commands as chat_mod
...
class TestResumeInteractiveWithSessions:
    ...
    def test_resume_interactive_valid_selection(self, real_agent_config, mock_llm_create, monkeypatch):
        ...
        from da.cli.list_selector_app import ListSelection
...
class TestSessionPreservationOnSwitch:
    ...
    def test_copy_session_delegates_to_session_manager(self, chat_cmd):
        ...
        with patch("da.models.session_manager.SessionManager") as mock_sm_cls:
    ...
    def test_copy_session_fallback_on_error(self, chat_cmd):
        ...
        with patch("da.models.session_manager.SessionManager", side_effect=Exception("no dir")):
            result = chat_cmd._copy_session_for_switch("chat_session_abc123", new_node)
...
class TestCreateNewNodeExtended:
    def test_create_chat_node_no_subagent(self, chat_cmd):
        with patch("da.agent.node.chat_agentic_node.ChatAgenticNode.__init__", return_value=None) as mock_init:
            chat_cmd._create_new_node(None)
        mock_init.assert_called_once()

    def test_create_gen_semantic_model(self, chat_cmd):
        mock_node = MagicMock()
        with patch("da.agent.node.gen_semantic_model_agentic_node.GenSemanticModelAgenticNode") as mock_cls:
            mock_cls.return_value = mock_node
            with patch.dict(
                "sys.modules",
                {"da.agent.node.gen_semantic_model_agentic_node": MagicMock(GenSemanticModelAgenticNode=mock_cls)},
            ):
    ...
    def test_create_gen_metrics(self, chat_cmd):
        mock_node = MagicMock()
        with patch(
            "da.agent.node.gen_metrics_agentic_node.GenMetricsAgenticNode",
            return_value=mock_node,
        ):
            with patch.dict(
                "sys.modules",
                {
                    "da.agent.node.gen_metrics_agentic_node": MagicMock(
    ...
    def test_create_gensql_default(self, chat_cmd):
        mock_node = MagicMock()
        with patch("da.agent.node.gen_sql_agentic_node.GenSQLAgenticNode") as mock_cls:
            mock_cls.return_value = mock_node
            with patch.dict(
                "sys.modules",
                {"da.agent.node.gen_sql_agentic_node": MagicMock(GenSQLAgenticNode=mock_cls)},
            ):
...
class TestCollectBatch:
    ...
    @patch("da.cli.chat_commands.select_choice", return_value="2")
    ...
    @patch("da.cli.chat_commands.select_choice", return_value="1")
    ...
    @patch("da.cli.chat_commands.select_choice", return_value="custom text")
...
class TestMakeInputCollector:
    ...
    @patch("da.cli.chat_commands.select_choice", return_value="y")
    ...
    @patch("da.cli.chat_commands.select_choice", return_value="")
...
class TestDropIfMatchesFinal:
    ...
    def test_pending_none_returns_none(self):
        from da.cli.chat_commands import _drop_if_matches_final
