...
"""
Unit tests for da/cli/agent_commands.py.
...
class TestCmdSave:
    ...
    def test_with_context_calls_output_tool(self, agent_commands):
        ...
        with patch("da.cli.agent_commands.OutputTool") as mock_output_cls:
...
class TestRunStandaloneNode:
    def test_cancel_returns_none(self, agent_commands):
        ...
        with patch("da.cli.agent_commands.Confirm.ask", return_value=False):
    ...
    def test_node_exception_returns_none(self, agent_commands):
        ...
        with patch("da.cli.agent_commands.Confirm.ask", return_value=True):
            with patch("da.cli.agent_commands.Node.new_instance", side_effect=RuntimeError("node error")):
                result = agent_commands.run_standalone_node(NodeType.TYPE_SCHEMA_LINKING, mock_input, need_confirm=True)
    ...
    def test_no_confirm_runs_node(self, agent_commands):
        ...
        with patch("da.cli.agent_commands.Node.new_instance", return_value=mock_node):
...
class TestPromptDbLayers:
    def test_sqlite_prompts_database_only(self, agent_commands):
        ...
        with patch("da.cli.agent_commands.connector_registry") as mock_registry:
...
class TestCmdDocSearchExtended:
    ...
    def test_success_path_displays_results(self, agent_commands):
        ...
        with patch("da.cli.agent_commands.ContextSearchTools"):
