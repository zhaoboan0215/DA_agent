...
"""Unit tests for da.cli.status_bar."""
...
from da.cli.status_bar import StatusBarProvider, StatusBarState, _humanize_tokens
...
class TestStatusBarState:
    ...
    def test_format_plain_includes_plan_marker_when_active(self):
        ...
        assert text.index("DA") < text.index("PLAN") < text.index("chat")
