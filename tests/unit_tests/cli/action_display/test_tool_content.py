...
"""Unit tests for da/cli/action_display/tool_content.py."""
...
from da.cli.action_display.tool_content import (
    ToolCallContent,
...
class TestMainSubParity:
    def test_same_content_compact(self):
        from da.cli.action_display.renderers import ActionContentGenerator
...
class TestCompactHelpers:
    ...
    def test_collapse_whitespace_flattens_newlines_and_tabs(self):
        from da.cli.action_display.tool_content import _collapse_whitespace

        assert _collapse_whitespace("a\n b\tc\r\nd") == "a b c d"
        assert _collapse_whitespace("   ") == ""

    def test_truncate_middle_short_stays_unchanged(self):
        from da.cli.action_display.tool_content import _truncate_middle
    ...
    def test_format_positional_picks_first_nonempty_key(self):
        from da.cli.action_display.tool_content import _format_positional
    ...
    def test_format_kw_joins_nonempty_pairs(self):
        from da.cli.action_display.tool_content import _format_kw
    ...
    def test_fallback_args_summary_limits_pairs(self):
        from da.cli.action_display.tool_content import _fallback_args_summary
    ...
    def test_extract_error_message_reads_error_field(self):
        from da.cli.action_display.tool_content import _extract_error_message
    ...
    def test_strip_legacy_preview_removes_known_prefixes(self):
        from da.cli.action_display.tool_content import _strip_legacy_preview
    ...
    def test_item_name_extracts_from_dict_or_str(self):
        from da.cli.action_display.tool_content import _item_name
    ...
    def test_fmt_count_with_preview_lists_first_items(self):
        from da.cli.action_display.tool_content import _fmt_count_with_preview
...
class TestExtractFileContent:
    ...
    def test_none_returns_none(self):
        from da.cli.action_display.tool_content import _extract_file_content
...
class TestToolArgsFormatters:
    ...
    def test_list_tables_kw_args(self):
        from da.cli.action_display.tool_content import _TOOL_ARGS_FORMATTERS
