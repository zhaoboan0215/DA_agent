...
"""Unit tests for da/cli/action_display/renderers.py (ActionRenderer)."""
...
from da.cli.action_display.renderers import ActionContentGenerator, ActionRenderer, _get_assistant_content
...
class TestRenderMainAction:
    ...
    def test_user_action(self):
        """USER action renders with Da> prefix."""
        action = _make_action(
            ActionRole.USER,
            ActionStatus.SUCCESS,
