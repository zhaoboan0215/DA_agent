...
"""Unit tests for da.cli._cli_utils — select_choice and select_list."""

from unittest.mock import MagicMock, patch

import pytest

from da.cli._cli_utils import _FREE_TEXT_SENTINEL, select_choice, select_list, select_multi_choice
...
class TestSelectChoiceBasic:
    ...
    @pytest.mark.ci
    @patch("da.cli._cli_utils.prompt_input", return_value="my custom answer")
    @patch("prompt_toolkit.Application")
    ...
    @pytest.mark.ci
    @patch("da.cli._cli_utils.prompt_input", return_value="")
    @patch("prompt_toolkit.Application")
...
class TestSelectMultiChoiceBasic:
    ...
    @pytest.mark.ci
    @patch("da.cli._cli_utils.prompt_input", return_value="custom text")
    @patch("prompt_toolkit.Application")
