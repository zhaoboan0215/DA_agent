...
"""Unit tests for :class:`DA.cli.model_app.ModelApp`.
...
from da.cli.model_app import ModelApp, ModelSelection, _Tab, _View
...
class TestEditCredentialsShortcut:
    ...
    def test_edit_prefills_base_url_from_saved_config(self):
        ...
        from da.cli.model_app import _MASKED_KEY_PLACEHOLDER
    ...
    def test_edit_on_subscription_opens_token_form_without_auto_detect(self):
        ...
        with (
            ...
            patch("da.auth.claude_credential.get_claude_subscription_token") as auto_detect,
        ):
            app._on_edit_credentials()
