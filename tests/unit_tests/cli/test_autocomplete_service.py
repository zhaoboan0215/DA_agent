...
"""Unit tests for ``DA.cli.autocomplete.ServiceCommandCompleter``."""
...
from da.cli.autocomplete import ServiceCommandCompleter
...
class TestServiceNameCompletion:
    ...
    def test_missing_adapter_annotated_in_display(self):
        ...
        # the real-world "DA-bi-<platform> not installed" scenario. (The
