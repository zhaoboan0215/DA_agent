...
"""Unit tests for da.gateway.bridge.ChannelBridge."""
...
from da.gateway.bridge import _MAX_BOT_MSG_MAP, ChannelBridge
...
class TestChannelBridge:
    ...
    async def test_new_command_clears_session(self, setup):
        ...
        with patch("da.gateway.bridge.SessionManager") as mock_sm_cls:
            mock_sm = MagicMock()
