...
class TestIsEmptyData:
    def test_none_is_empty(self):
        from da.utils.compress_utils import _is_empty_data
...
class TestDataCompressorCompress:
    ...
    @patch("da.utils.compress_utils.litellm.token_counter", side_effect=_mock_token_counter)
    ...
    @patch("da.utils.compress_utils.litellm.token_counter")
