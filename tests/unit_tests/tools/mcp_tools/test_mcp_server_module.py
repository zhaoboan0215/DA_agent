...
"""Unit tests for da/tools/mcp_tools/mcp_server.py (SilentMCPServerStdio + find_mcp_directory + MCPServer)"""
...
from da.tools.mcp_tools.mcp_server import MCPServer, SilentMCPServerStdio, find_mcp_directory
...
class TestSilentMCPServerStdio:
    ...
    def test_unix_wraps_with_sh(self):
        ...
        with patch("da.tools.mcp_tools.mcp_server.MCPServerStdio.__init__", return_value=None):
...
class TestMCPServer:
    ...
    def test_returns_none_when_dir_env_not_set_and_not_found(self):
        with patch.dict("os.environ", {}, clear=False):
            ...
            with patch(
                "da.tools.mcp_tools.mcp_server.find_mcp_directory", side_effect=FileNotFoundError("not found")
            ):
    ...
    def test_creates_server_when_valid_directory(self, tmp_path):
        ...
        with patch.dict("os.environ", {"METRICFLOW_MCP_DIR": str(tmp_path)}):
            with patch("da.tools.mcp_tools.mcp_server.SilentMCPServerStdio") as mock_cls:
