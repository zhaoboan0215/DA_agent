...
"""Unit tests for da/tools/llms_tools/match_schema.py"""
...
from da.tools.llms_tools.match_schema import MatchSchemaTool, gen_all_table_dict, parse_matched_tables
...
class TestMatchSchemaTool:
    ...
    def test_execute_exception_raises_DA_exception(self):
    ...
    def test_match_schema_uses_direct_match_for_small_table(self):
        ...
        with (
            patch("da.tools.llms_tools.match_schema.gen_prompt", return_value="prompt"),
            patch("da.tools.llms_tools.match_schema.llm_result2json", return_value=[]),
        ):
