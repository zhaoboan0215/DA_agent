...
"""Unit tests for da/tools/llms_tools/visualization_tool.py"""
...
from da.schemas.visualization import VisualizationInput, VisualizationOutput
...
class TestVisualizationToolInit:
    ...
    def test_init_with_agent_config_creates_model(self):
        ...
        with patch("da.tools.llms_tools.visualization_tool.LLMBaseModel") as mock_base:
...
class TestExecute:
    ...
    def test_uses_llm_when_model_available(self):
        ...
        with patch("da.tools.llms_tools.visualization_tool.get_prompt_manager") as mock_gpm:
