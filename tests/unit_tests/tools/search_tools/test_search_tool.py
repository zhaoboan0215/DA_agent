...
"""Unit tests for da.tools.search_tools.search_tool — _get_document_store."""

from unittest.mock import MagicMock, patch

from da.schemas.doc_search_node_models import DocSearchInput, DocSearchResult
from da.tools.search_tools.search_tool import SearchTool, search_by_tavily
...
class TestGetDocumentStore:
    ...
    def test_returns_store_when_has_data(self):
        ...
        with patch("da.tools.search_tools.search_tool.document_store", return_value=mock_store):
