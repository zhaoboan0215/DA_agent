...
"""Tests for SkillCommands (da/cli/skill_commands.py)."""
...
class TestSkillCommandsDispatch:
    ...
    @patch.object(__import__("da.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_list")
    ...
    @patch.object(__import__("da.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_search")
    ...
    @patch.object(__import__("da.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_install")
    ...
    @patch.object(__import__("da.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_publish")
    ...
    @patch.object(__import__("da.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_info")
    ...
    @patch.object(__import__("da.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_update")
    ...
    @patch.object(__import__("da.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_remove")
...
class TestSkillCommandsRemove:
    ...
    @patch("da.cli._cli_utils.confirm_prompt", return_value=True)
...
class TestSkillCommandsLogin:
    @patch("da.tools.skill_tools.marketplace_auth.save_token")
    @patch("da.cli._cli_utils.prompt_input", side_effect=["test@test.com", "pass"])
    @patch("httpx.Client")
    ...
    @patch("da.cli._cli_utils.prompt_input", side_effect=["test@test.com", "wrong"])
    @patch("httpx.Client")
...
class TestSkillCommandsLogout:
    @patch("da.tools.skill_tools.marketplace_auth.clear_token", return_value=True)
    ...
    @patch("da.tools.skill_tools.marketplace_auth.clear_token", return_value=False)
