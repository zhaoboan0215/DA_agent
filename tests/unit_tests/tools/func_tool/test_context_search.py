...
from da.tools.func_tool.base import normalize_null
from da.tools.func_tool.context_search import _fill_subject_tree, _normalize_subject_tree
...
def build_tools(mock_agent_config):
    def _builder(metric_cfg=None, sql_cfg=None, knowledge_cfg=None, semantic_cfg=None):
        ...
        with (
            patch("da.tools.func_tool.context_search.MetricRAG", return_value=metric_rag),
            patch("da.tools.func_tool.context_search.SemanticModelRAG", return_value=semantic_rag),
            patch("da.tools.func_tool.context_search.ReferenceSqlRAG", return_value=sql_rag),
            patch("da.tools.func_tool.context_search.ExtKnowledgeRAG", return_value=ext_knowledge_rag),
            patch("da.tools.func_tool.context_search.ReferenceTemplateRAG", return_value=reference_template_rag),
            patch(
                "da.tools.func_tool.context_search.MetricRAG.storage.subject_tree",
                return_value=Mock(),
            ),
        ):
...
class TestCreateFactoryMethods:
    def test_create_dynamic(self, mock_agent_config):
        ...
        with (
            patch("da.tools.func_tool.context_search.MetricRAG", return_value=mock_metric),
            patch("da.tools.func_tool.context_search.SemanticModelRAG", return_value=mock_semantic),
            patch("da.tools.func_tool.context_search.ReferenceSqlRAG", return_value=mock_sql),
            patch("da.tools.func_tool.context_search.ExtKnowledgeRAG", return_value=mock_knowledge),
            patch("da.tools.func_tool.context_search.ReferenceTemplateRAG", return_value=mock_ref_tpl),
        ):
            from da.tools.func_tool.context_search import ContextSearchTools
