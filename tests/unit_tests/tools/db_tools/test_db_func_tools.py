"""
Test cases for DBFuncTool class in da/tools/tools.py
"""
...
from da.tools.db_tools import BaseSqlConnector, connector_registry
...
class TestDBFuncTool:
    ...
    def test_catalog_scoped_tables_filter_results(self, monkeypatch):
        ...
        # In production this is done by the external DA_snowflake adapter package.
    ...
    def test_scoped_tables_loaded_from_agent_config(self, monkeypatch, mock_connector):
        ...
        monkeypatch.setattr("da.tools.func_tool.database.SchemaWithValueRAG", StubSchemaRAG)
        monkeypatch.setattr("da.tools.func_tool.database.SemanticModelRAG", StubSemanticRAG)
