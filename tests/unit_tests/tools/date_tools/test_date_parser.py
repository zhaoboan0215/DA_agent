...
from da.tools.date_tools.date_parser import DateParserTool
...
class TestExtractAndParseDates:
    def test_returns_empty_when_no_expressions(self):
        ...
        with patch("da.tools.date_tools.date_parser.get_date_extraction_prompt", return_value="prompt"):
            with patch("da.tools.date_tools.date_parser.parse_date_extraction_response", return_value=[]):
    ...
    def test_parses_extracted_expressions(self):
        ...
        with patch("da.tools.date_tools.date_parser.get_date_extraction_prompt", return_value="prompt"):
            with patch("da.tools.date_tools.date_parser.parse_date_extraction_response", return_value=expressions):
...
class TestParseWithLlm:
    def test_returns_start_end_dates_on_success(self):
        ...
        with patch("da.tools.date_tools.date_parser.get_prompt_manager") as mock_gpm:
...
class TestGenerateDateContext:
    ...
    def test_formats_range_date(self):
        from da.schemas.date_parser_node_models import ExtractedDate
