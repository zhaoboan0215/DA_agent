...
"""Unit tests for da.storage.document.fetcher.github_fetcher."""
...
def _make_fetcher(**kwargs):
    ...
    with patch("da.storage.document.fetcher.github_fetcher.Github") as MockGithub:
...
class TestGitHubFetchMetadata:
    ...
    def test_metadata_creation(self):
        ...
        from da.storage.document.fetcher.github_fetcher import GitHubFetchMetadata
