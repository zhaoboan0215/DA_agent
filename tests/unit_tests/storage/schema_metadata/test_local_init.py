...
"""Unit tests for da.storage.schema_metadata.local_init."""

from unittest.mock import MagicMock, patch

import pytest

from da.storage.schema_metadata.local_init import _fill_sample_rows, store_tables
...
class TestInitSqliteSchema:
    def test_calls_get_tables_with_ddl(self):
        from da.storage.schema_metadata.local_init import init_sqlite_schema
        ...
        with patch(
            "da.storage.schema_metadata.local_init.exists_table_value",
            return_value=({}, set()),
        ):
...
class TestInitDuckdbSchema:
    def test_calls_get_tables_with_ddl(self):
        from da.storage.schema_metadata.local_init import init_duckdb_schema
...
class TestInitOtherThreeLevelSchema:
    def test_calls_get_tables_with_ddl(self):
        from da.storage.schema_metadata.local_init import init_other_three_level_schema
        ...
        with (
            ...
            patch("da.storage.schema_metadata.local_init.connector_registry") as mock_registry,
        ):
...
class TestInitLocalSchema:
    ...
    def test_sqlite_dispatched(self):
        ...
        with patch("da.storage.schema_metadata.local_init.init_sqlite_schema") as mock_init_sqlite:
    ...
    def test_duckdb_dispatched(self):
        ...
        with patch("da.storage.schema_metadata.local_init.init_duckdb_schema") as mock_init_duckdb:
            init_local_schema(mock_store, agent_config, db_manager)
    ...
    def test_other_db_dispatched(self):
        ...
        with patch("da.storage.schema_metadata.local_init.init_other_three_level_schema") as mock_init_other:
            init_local_schema(mock_store, agent_config, db_manager)
    ...
    def test_multiple_db_configs_iterates_all(self):
        ...
        with (
            patch("da.storage.schema_metadata.local_init.init_sqlite_schema") as mock_init_sqlite,
            patch(
                "da.storage.schema_metadata.local_init.exists_table_value",
                return_value=({}, set()),
            ),
