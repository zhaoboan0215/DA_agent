...
"""Unit tests for da.storage.registry (singleton storage)."""

from unittest.mock import MagicMock, patch

import pytest

from da.storage.registry import (
...
class _DummyStore:
    ...
    def __init__(self, embedding_model, **kwargs):
        ...
        from da.storage.base import _SharedTableState
...
class TestGetStorage:
    ...
    def test_same_factory_returns_same_instance(self):
        ...
        with patch("da.storage.registry.get_embedding_model", side_effect=_fake_get_embedding_model):
