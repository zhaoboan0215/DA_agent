...
from da.storage.reference_template.template_file_processor import (
...
class TestProcessTemplateFiles:
    ...
    def test_non_j2_file_raises(self):
        """A file with non-.j2 extension should raise DaException."""
...
class TestResolveDimensionColumns:
    ...
    def test_resolves_simple_where_eq(self):
        from da.storage.reference_template.template_file_processor import _resolve_dimension_columns
