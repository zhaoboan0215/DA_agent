...
"""Unit tests for da.storage.reference_template.reference_template_init."""
...
from da.storage.reference_template.reference_template_init import (
    BIZ_NAME,
...
class TestInitReferenceTemplateValidateOnly:
    ...
    @patch("da.storage.reference_template.template_file_processor.log_invalid_entries")
...
class TestInitReferenceTemplateAsync:
    def test_async_function_is_importable(self):
        from da.storage.reference_template.reference_template_init import init_reference_template_async
...
class TestTemplateExtraInstructions:
    def test_instructions_mention_jinja2(self):
        from da.storage.reference_template.reference_template_init import TEMPLATE_EXTRA_INSTRUCTIONS
...
class TestProcessTemplateItem:
    ...
    async def test_success_with_complete_yaml(self, tmp_path):
        ...
        from da.schemas.action_history import ActionHistory, ActionStatus
        from da.storage.reference_template.reference_template_init import process_template_item
        ...
        with patch(
            "da.storage.reference_template.reference_template_init.SqlSummaryAgenticNode",
...
class TestInitReferenceTemplateAsyncProcessing:
    ...
    async def test_overwrite_processes_all_items(self, tmp_path):
        ...
        with patch(
            "da.storage.reference_template.reference_template_init.process_template_item",
    ...
    async def test_incremental_skips_existing(self, tmp_path):
        ...
        from da.storage.reference_template.init_utils import gen_reference_template_id
        from da.storage.reference_template.reference_template_init import init_reference_template_async
...
class TestIsSafeIdentifier:
    def test_plain_identifier(self):
        from da.storage.reference_template.reference_template_init import _is_safe_identifier
...
class TestEnrichDimensionParam:
    def test_enrich_success(self):
        ...
        from da.storage.reference_template.reference_template_init import _enrich_dimension_param
...
class TestEnrichColumnParam:
    def test_enrich_success(self):
        ...
        from da.storage.reference_template.reference_template_init import _enrich_column_param
        from da.tools.func_tool.base import FuncToolResult
...
class TestExtractCsvValues:
    def test_valid_compressed_data(self):
        ...
        from da.storage.reference_template.reference_template_init import _extract_csv_values
        from da.tools.func_tool.base import FuncToolResult
