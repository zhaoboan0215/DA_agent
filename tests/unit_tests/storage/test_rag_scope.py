...
"""Unit tests for da.storage.rag_scope."""
...
class TestBuildSubAgentFilter:
    ...
    def test_subject_scope_without_tree_raises(self):
        """Subject-based scope without subject_tree on storage -> raises DaException."""
        import pytest
        ...
        with pytest.raises(DaException, match="subject_tree"):
