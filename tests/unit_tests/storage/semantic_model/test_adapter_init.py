...
"""Unit tests for da.storage.semantic_model.adapter_init."""
...
class TestInitFromAdapter:
    ...
    @pytest.mark.asyncio
    @patch("da.storage.semantic_model.adapter_init.SemanticStorageManager")
    @patch("da.storage.semantic_model.adapter_init.semantic_adapter_registry")
    ...
    async def test_dict_adapter_config_datasource_defaulting(self, mock_registry, MockStorageManager):
        ...
        with patch("da.tools.semantic_tools.config.SemanticAdapterConfig") as MockConfig:
