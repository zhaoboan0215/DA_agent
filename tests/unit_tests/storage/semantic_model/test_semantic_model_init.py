...
"""Unit tests for da.storage.semantic_model.semantic_model_init."""
...
class TestProcessSemanticYamlFile:
    ...
    def test_sync_success(self, tmp_path):
        ...
        with patch(
            "da.storage.semantic_model.semantic_model_init.GenerationHooks._sync_semantic_to_db",
...
class TestInitSuccessStorySemanticModelAsync:
    ...
    def test_async_function_is_importable(self):
        ...
        from da.storage.semantic_model.semantic_model_init import init_success_story_semantic_model_async
...
class TestInitSuccessStorySemanticModelSync:
    ...
    def test_sync_function_is_importable(self):
        ...
        from da.storage.semantic_model.semantic_model_init import init_success_story_semantic_model
...
class TestInitSuccessStorySemanticModelAsyncLLMPath:
    ...
    async def test_success_path_with_semantic_models_list(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "da.storage.semantic_model.semantic_model_init.GenSemanticModelAgenticNode",
            MockSemanticNode,
        )
