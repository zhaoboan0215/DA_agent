...
"""Unit tests for da.storage.semantic_model.auto_create."""
...
class TestExtractTablesFromSqlList:
    ...
    def test_extracts_tables_from_simple_select(self):
        ...
        from da.storage.semantic_model.auto_create import extract_tables_from_sql_list
...
class TestFindMissingSemanticModels:
    ...
    def test_empty_tables_returns_empty(self):
        ...
        from da.storage.semantic_model.auto_create import find_missing_semantic_models

        config = MagicMock()
        result = find_missing_semantic_models(set(), config)
        assert result == []

    @patch("da.storage.semantic_model.store.SemanticModelRAG")
...
class TestCreateSemanticModelsForTables:
    ...
    async def test_empty_tables_returns_true(self):
        ...
        from da.storage.semantic_model.auto_create import create_semantic_models_for_tables
    ...
    async def test_success_path(self):
        ...
        with (
            patch(
                "da.agent.node.gen_semantic_model_agentic_node.GenSemanticModelAgenticNode",
                MockNode,
            ),
            patch(
                "da.schemas.semantic_agentic_node_models.SemanticNodeInput",
...
class TestCreateSemanticModelsForTablesSync:
    ...
    def test_empty_tables_returns_true(self):
        ...
        from da.storage.semantic_model.auto_create import create_semantic_models_for_tables_sync
    ...
    def test_wraps_async_function(self, monkeypatch):
        ...
        from da.storage.semantic_model import auto_create
