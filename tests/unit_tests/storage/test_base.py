...
"""Tests for da/storage/base.py — StorageBase and BaseEmbeddingStore."""
...
from da.storage.base import BaseEmbeddingStore, StorageBase
from da.storage.embedding_models import EmbeddingModel, get_db_embedding_model
from da.storage.schema_metadata import SchemaStorage
...
class TestCheckEmbeddingModelReady:
    ...
    def test_check_embedding_model_ready_raises_when_model_failed(self, tmp_path):
        """If the model is already marked as failed, a DaException should be raised."""
...
class TestUpsertWithRetry:
    ...
    def test_upsert_with_retry_raises_when_table_none(self, tmp_path):
        """Raises DaException when table is None."""
        import pandas as pd
