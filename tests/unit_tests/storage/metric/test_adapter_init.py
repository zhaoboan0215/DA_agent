...
"""Unit tests for da.storage.metric.adapter_init."""
...
class TestInitFromAdapter:
    ...
    @pytest.mark.asyncio
    @patch("da.storage.metric.adapter_init.SemanticStorageManager")
    @patch("da.storage.metric.adapter_init.semantic_adapter_registry")
