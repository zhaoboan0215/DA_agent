...
"""
Unit tests for da/mcp_server.py
...
from da.mcp_server import ToolContext, ToolContextManager
...
def context_manager(mock_config_manager):
    with patch("da.mcp_server.configuration_manager", return_value=mock_config_manager):
...
class TestFormatResult:
    def test_func_tool_result_converted(self):
        from da.mcp_server import LightweightDynamicMCPServer
...
class TestGetContext:
    def test_raises_when_no_context(self):
        from da.mcp_server import LightweightDynamicMCPServer, _current_tool_context
