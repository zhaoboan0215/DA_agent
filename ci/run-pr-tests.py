...
IMPACTED_TEST_MAPPING = [
    ("da/agent/", "tests/unit_tests/agent/"),
    ("da/api/", "tests/unit_tests/api/"),
    ("da/cli/", "tests/unit_tests/cli/"),
    ("da/configuration/", "tests/unit_tests/configuration/"),
    ("da/models/", "tests/unit_tests/models/"),
    ("da/storage/", "tests/unit_tests/storage/"),
    ("da/tools/", "tests/unit_tests/tools/"),
    ("da/utils/", "tests/unit_tests/utils/"),
    ("ci/", "tests/unit_tests/ci/"),
    # Catch top-level da/ changes (for example __init__.py or future shared modules)
    ...
    if compare_branch:
        ...
        proc = _run_cmd(
            [
                ...
                "--fail-under=0",
                "--exclude",
                "da/cli/web/chatbot.py",
                "--exclude",
                "da/cli/screen/subject_screen.py",
            ],
            DIFF_COVER_TIMEOUT,
            capture_output=True,
            text=True,
